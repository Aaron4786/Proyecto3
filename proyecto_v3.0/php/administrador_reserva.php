<?php
		...
		$encurso =	" SELECT * FROM tbl_reserva INNER JOIN tbl_recurso ON tbl_recurso.rec_id = tbl_reserva.res_recursoid INNER JOIN tbl_usuario ON tbl_usuario.usu_id = tbl_reserva.res_usuarioid WHERE res_fechafinal xIS NULL";
